...
function Login() {
    ...
    useEffect(() => {
      ...
      if(error === "account_exists" && provider && !hasShownError.current){
        console.log("In the if statement");
        console.log("About to show toast");
        hasShownError.current = true;
        
        // Show toast immediately
        toast.info(`An account with this email already exists. Please sign in using your ${provider} account instead.`);
        console.log("Toast called");
        
        // Navigate after a longer delay to ensure toast is visible
        setTimeout(() => {
